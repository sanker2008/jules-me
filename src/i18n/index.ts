...
const zhHans = {
  ...
  checkUpdate: '检查更新',
  releaseNotesTitle: 'v1.1.9 更新内容',
  releaseNotesText: '升级 Expo 57 稳定版本，优化聊天轮询与请求超时，加固 Pro 激活，并修复 Android 正式签名流程。',
...
const zhHant = {
  ...
  checkUpdate: '檢查更新',
  releaseNotesTitle: 'v1.1.9 更新內容',
  releaseNotesText: '升級 Expo 57 穩定版本，優化聊天輪詢與請求逾時，加固 Pro 啟用，並修復 Android 正式簽章流程。',
...
const en = {
  ...
  releaseNotesTitle: 'v1.1.9 release notes',
  releaseNotesText: 'Updates Expo 57 stability, improves chat polling and request timeouts, hardens Pro activation, and fixes Android release signing.',
  ...
  proMonthlyPlan: '☕ Monthly trial',
  proLifetimePlan: '👑 Lifetime',
  ...
  proMonthlyActive: (days: number) => `☕ Pro monthly trial · ${days} days left`,
