...
const zhHans = {
  ...
  checkUpdate: '检查更新',
  releaseNotesTitle: 'v1.1.15 更新内容',
  releaseNotesText: '新增主题自适应首页背景，完善 Pro 编码规范与真实交付战报；连接失败不再保存 API Key，并修复无历史返回。',
...
const zhHant = {
  ...
  checkUpdate: '檢查更新',
  releaseNotesTitle: 'v1.1.15 更新內容',
  releaseNotesText: '新增主題自適應首頁背景，完善 Pro 編碼規範與真實交付戰報；連線失敗不再儲存 API Key，並修復無歷史返回。',
...
const en = {
  ...
  releaseNotesTitle: 'v1.1.15 release notes',
  releaseNotesText: 'Adds theme-aware home artwork and truthful Pro delivery reports, prevents rejected API Keys from being saved, and makes back navigation safe.',
